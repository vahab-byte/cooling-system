        ...
        <div className="grid lg:grid-cols-12 gap-20 items-center mb-32 py-20">
          <div className="lg:col-span-7">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-9xl font-bold text-black leading-[1.05] mb-10 tracking-tighter font-display">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2, duration: 0.8 }}>
              <div className="relative rounded-none overflow-hidden border border-neutral-200 shadow-2xl group">
                <img 
                  ...
                  className="w-full h-[400px] md:h-[750px] object-cover grayscale group-hover:grayscale-0 transition-all duration-1000"
                />
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-12 md:left-12 md:right-12">
                   <div className="bg-white p-6 md:p-12 border border-neutral-200 text-black shadow-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div 
                ...
                className="p-6 sm:p-10 lg:p-16 bg-white border border-neutral-200 hover:border-blue-600 transition-all duration-500 group relative overflow-hidden"
              >
