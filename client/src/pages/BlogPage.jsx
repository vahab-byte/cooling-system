...
import { Calendar, User, ArrowRight, BookOpen, Clock, Sparkles, ChevronRight, Zap, Loader2, Search } from 'lucide-react';
...
const BlogCardSkeleton = () => (
  <div className="flex flex-col animate-pulse">
    <div className="aspect-[4/5] bg-slate-100 rounded-[2.5rem] mb-10" />
...
const BlogPage = () => {
  ...
  const regularPosts = posts.filter(p => p.id !== (activeCategory === 'All' && featuredPost ? featuredPost.id : null));

  return (
    <>
      <SEO 
        title="Blog — Arctic Insights" 
        description="Strategic intelligence on high-performance cooling, thermodynamic precision, and the evolution of climate control protocols."
        path="/blog"
      />
                 ...
                 <div className="flex flex-col gap-4">
                   ...
                   <div className="relative">
                     ...
                     <input
                       ...
                       className="pl-11 pr-6 py-3 rounded-xl text-sm font-bold text-slate-700 placeholder:text-slate-300 bg-white border border-slate-100 focus:border-primary focus:outline-none transition-all w-full lg:w-72"
                     />
                   </div>
          ...
          {loading ? (
            ...
            <>
              ...
              {activeCategory === 'All' && featuredPost && (
                ...
                >
                  <Link to={`/blog/${featuredPost.slug}`} className="grid lg:grid-cols-2 gap-16 items-center">
                       ...
                       <div className="flex items-center justify-between pt-8 border-t border-slate-100">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                ...
                                <div className="text-xs font-black text-slate-950">{featuredPost.author_name}</div>
                             </div>
                          </div>
                          
                          <div className="flex items-center gap-4 text-slate-950 group-hover:translate-x-3 transition-transform">
                             <span className="text-xs font-black uppercase tracking-[0.3em]">Read Article</span>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16">
                <AnimatePresence mode="popLayout">
                  {(activeCategory === 'All' ? regularPosts : posts).map((post, i) => (
                    <motion.article 
                      key={post.id || i}
                      layout
                    ...
                    >
                      <Link to={`/blog/${post.slug}`}>
                        <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] mb-10 border border-slate-100 shadow-xl">
                          <img 
                            src={post.cover_image || "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&q=80&w=800"} 
                            alt={post.title} 
                        ...
                        <div className="space-y-6 px-4">
                          ...
                          <div className="flex items-center gap-3 pt-6 border-t border-slate-50">
                            ...
                            <span className="text-[10px] font-black text-slate-900 uppercase tracking-widest">{(post.author_name || '').split(',')[0]}</span>
                          </div>
                        </div>
                      </Link>
                    </motion.article>
          ...
          <section className="mt-40 relative">
             <div className="bg-slate-950 rounded-[4rem] p-8 sm:p-16 lg:p-32 text-center relative overflow-hidden group">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                   ...
                   <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-12" onSubmit={e => e.preventDefault()}>
                      <input 
                        type="email" 
                        required
